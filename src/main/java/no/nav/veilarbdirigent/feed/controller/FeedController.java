package no.nav.veilarbdirigent.feed.controller;

import no.nav.veilarbdirigent.feed.common.Authorization;
...
public class FeedController {
    ...
    public FeedController addFeed(String clientFeedname, FeedConsumer consumer) {
