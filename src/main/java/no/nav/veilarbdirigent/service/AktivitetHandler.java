...
public class AktivitetHandler implements MessageHandler, Actuator<AktivitetHandler.OppfolgingDataMedMal, String> {
    ...
    private Core core;
    private VeilarbaktivitetClientImpl service;
    private VeilarbmalverkClientImpl malverk;
    ...
    public AktivitetHandler(Core core, VeilarbaktivitetClientImpl service, VeilarbmalverkClientImpl malverk) {
        this.core = core;
